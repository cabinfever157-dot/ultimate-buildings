...
0<d[g].children.length&&(f.children=c(d[g].children));if(0<=d[g].caption.toLowerCase().indexOf(a))e.push(f);else if(f.children&&0<f.children.length)for(var l=0;l<f.children.length;l++)e.push(f.children[l])}return e};return b=c(ols)},pickElements:function(a){a.input=this.input;a.searchButton=this.searchButton;a.result=this.result;a.searchButtonUrl=this.searchButtonUrl;a.tableofcontentSwiper=this.tableofcontentSwiper;a.tableofcontentSwiperList=this.tableofcontentSwiperList;a.progress=this.progress;
...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});this.descriptionTitle.css({"background-color":this.fontColorObj.rgba(.2),color:this.fontColor,border:"1px solid "+this.fontColorObj.rgba(.2),"border-right":"none"});this.contactTitle.css({"background-color":"transparent",color:this.fontColor,border:"1px solid "+this.fontColorObj.rgba(.2),
"border-left":"none"})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);if(bookConfig.CompanyLogoFile||bookConfig.AboutDescription)this.stage.append(this.descriptionTitle),this.stage.append(this.contactTitle);this.content1=$("<div class='content content1'></div>");this.stage.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);
this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);this.content2=$("<div class='content content2 stage'></div>");this.swiper=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.progress.append(this.progressBar);this.content2.append(this.progress);this.stage.append(this.content2);this.content2.append(this.swiper);bookConfig.CompanyLogoFile&&this.swiper.append(this.logo);
this.swiper.append(this.description);this.content2.scroll({},Direction.top,"win10");this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.css("height","230px"),this.content1.append(this.views),clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},initLogo:function(){bookConfig.CompanyLogoFile||bookConfig.AboutDescription?(this.stage.find(".focus")[0]||
this.contactTitle.addClass("focus"),this.stage.find(this.descriptionTitle)[0]||this.stage.append(this.descriptionTitle),this.stage.find(this.contactTitle)[0]||this.stage.append(this.contactTitle),this.stage.find(this.content2)[0]||this.stage.append(this.content2),bookConfig.CompanyLogoFile&&!this.swiper.find(this.logo)[0]&&this.swiper.prepend(this.logo),bookConfig.AboutDescription&&this.content2.refreshData()):(this.stage.find(this.content2)[0]&&this.content2.remove(),this.stage.find(this.descriptionTitle)[0]&&
this.descriptionTitle.remove(),this.stage.find(this.contactTitle)[0]&&this.contactTitle.remove(),this.showContact())},showContact:function(){this.descriptionTitle.removeClass("focus");this.contactTitle.addClass("focus");this.descriptionTitle.css({background:"transparent"});this.contactTitle.css({background:this.fontColorObj.rgba(.15)});this.content1.show();this.content2.hide()},showDescription:function(){this.contactTitle.removeClass("focus");this.descriptionTitle.addClass("focus");this.descriptionTitle.css({background:this.fontColorObj.rgba(.15)});
this.contactTitle.css({background:"transparent"});this.content2.show();this.content2.refreshData();this.content1.hide()},onShow:function(){this._super();bookConfig.CompanyLogoFile||bookConfig.AboutDescription?this.showDescription():this.showContact();this.content2.refreshData()}}).extend(PcAboutFrame);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.fontColor;this._super(a,b)}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){this.progressBar.css({"background-color":this.fontColorObj.rgba(.5)})},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this._super();this.stage.css({"background-color":this.mainColor,color:this.fontColor,"box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-webkit-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-moz-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5)});this.leftAddPage.css({"background-color":this.fontColor,color:this.mainColor});this.rightAddPage.css({"background-color":this.fontColor,
color:this.mainColor});this.input.css({border:"1px solid "+this.fontColorObj.rgba(.1)});this.bookmarkListTitle.css({"background-color":this.fontColorObj.rgba(.1)});this.remove.css({"background-color":this.fontColorObj.rgba(.2)})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);
this.stage.append(a);this.stage.append(this.leftAddPage);this.stage.append(this.rightAddPage);this.stage.append(this.bookmarkListTitle);this.stage.append(this.bookmarkListPanel.bookmarkSwiper);this.stage.append(this.remove);this.parent.append(this.stage);this.refreshPanel()},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=300;this.height=a-40;this.maxHeight=this.height-
188;this.stage.find(".bookmark_content").css({height:a-87+"px"});this.stage.css({height:this.height+"px",top:b+"px"});this.bookmarkListPanel.onResize(this.width,this.maxHeight);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.image);this.title1&&this.stage.append(this.title1);this.title2&&this.stage.append(this.title2);this._super()}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.previewBox.css({border:"1px solid "+this.fontColor});this.printDiv.css({border:"1px solid "+this.fontColor});this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.printDivTitle.css({"background-color":this.mainColor});this.contentTitle.css({"background-color":this.mainColor});
this.printButton.css({"background-color":this.fontColorObj.rgba(.7),color:this.mainColor})},changeIconColor:function(){this.close&&this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.pictureListForm.leftBtn.changeButtonColor(this.fontColor);this.pictureListForm.rightBtn.changeButtonColor(this.fontColor);this.changeItemColor()},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='content'></div>");this.contentTitle=$('<div class="contentTitle">'+getLanguage("tmpl_PrintPreview","PREVIEW")+"</div>");this.stage.append(this.content);this.previewBox=this.pictureListForm.getDom();this.previewBox.append(this.contentTitle);this.content.append(this.previewBox);this.printDiv=$("<div class='printDiv'></div>");this.printDivTitle=$('<div class="printDivTitle">'+getLanguage("print","PRINT")+"</div>");
this.printDiv.append(this.printDivTitle);this.appendPrintOptions(this.printDiv);this.content.append(this.printDiv);this.initMoreEvent();this._super()},initMoreEvent:function(){this.printRange.find("#print_range_num").bind("focus",function(){$(this).css({opacity:1})});this.printRange.find("#print_range_num").bind("blur",function(){ifRegNull=!/(^\s+)|(\s+$)/g.test($(this).val());""!==$(this).val()&&ifRegNull?$(this).css({opacity:1}):$(this).css({opacity:.7})})}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({nailUpIcon:null,nailUpStatus:!0,create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor,"box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-webkit-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-moz-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5)});this.progressBar.css({"background-color":this.fontColorObj.rgba(.5)})},initHtml:function(){this.nailUpIcon=
$("<img alt='nail up' width='auto' height='auto' class='nailUp nailUpActive' src='"+(form_icons.nailUp?"data:image/png;base64,"+form_icons.nailUp:uiBaseURL+"nailUp.png")+"'/>");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.tableofcontentSwiper);this.stage.append(this.nailUpIcon);this.parent.append(this.stage);this.nailUpIcon.bind("click",function(){this.nailUpIcon.toggleClass("nailUpActive");
this.nailUpStatus=!this.nailUpStatus;var a=$(".tableofcontent_form").outerWidth(!0),b=parseInt(_get(global,"staticAd.adPosition",1));this.nailUpStatus?(bookConfig.leftMargin+=a+10,window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(b)&&$("#slide-show").css({width:"calc(100% - 10px - "+a+"px)",right:"0px"})):(bookConfig.leftMargin-=a+10,window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(b)&&$("#slide-show").css({width:"100%",right:"0px"}));
onStageResize()}.bind(this))},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-40;this.maxHeight=this.height-40;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()},show:function(){this.visible=!0;this.stage.animate({left:10},400,function(){this.setA11yAndFocus()}.bind(this));
this.onShow();if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);bookConfig.leftMargin+=a+10;onStageResize();var b=parseInt(_get(global,"staticAd.adPosition",1));window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(b)&&$("#slide-show").css({width:"calc(100% - 10px - "+a+"px)",right:"0px"})}},hide:function(){this.visible=!1;this.stage.animate({left:2*-this.width},400,function(){this.onHide()}.bind(this));if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);
bookConfig.leftMargin-=a+10;onStageResize();a=parseInt(_get(global,"staticAd.adPosition",1));window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(a)&&$("#slide-show").css({width:"100%",right:"0px"})}}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});this.video.css({"background-color":this.fontColorObj.rgba(.3)})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);
if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width","335px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){bookConfig.addCurrentPage&&this.content.css({height:"215px"});this._super()},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");this.shareSwiper=$("<div class='shareSwiper swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.shareSwiper.append(this.sharePanel);
