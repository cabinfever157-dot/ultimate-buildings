...
frmSearch.search(a))},show:function(){var a=toolBar.getTopHeight(!0);this.menu.animate({top:a},300);this.visible=!0},hide:function(){this.menu.animate({top:-60},300);this.visible=!1},showOrHide:function(){!0===this.visible?this.hide():this.show()},changeLanguage:function(){this.searchBarInput.attr("placeholder",FormInfo.getFormTitle("search"))}});var PcSearchItem=Class({create:function(a,b){b.fontColor=this.fontColor;this._super(a,b)}}).extend(SearchItem);var PcSearchForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.SwiperContainer.css({"background-color":this.mainColor,"box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-webkit-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-moz-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5)});this.input.css({background:this.mainColor,color:this.fontColor,"box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-webkit-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),
"-moz-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5)});this.searchPageSwiper.css({"background-color":this.mainColor,"box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-webkit-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5),"-moz-box-shadow":"0 0 8px "+this.fontColorObj.rgba(.5)});this.stage.css({"background-color":"transparent",color:this.fontColor});this.searchSwiper.css({"background-color":this.mainColor});this.progressBar.css({"background-color":this.fontColorObj.rgba(.5)})},initHtml:function(){this.SwiperContainer=
$('<div class="stageContainer"></div>');this.SwiperContainer.append(this.searchResult);this.stage.append(this.title);this.stage.append(this.nailUpIcon);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.input);this.stage.append(this.searchButton);this.stage.append(this.searchPageSwiper);this.searchPageSwiper.css({"margin-top":"3px"});this.SwiperContainer.append(this.$matchType);this.SwiperContainer.append(this.searchSwiper);
this.stage.append(this.SwiperContainer);this.parent.append(this.stage)},afterSearchThumbs:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-288+"px")},afterSearchText:function(){this.height=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1)-40;this.searchSwiper.css("height",this.height-88+"px");this.searchPageSwiper.css({display:"none"})},onResize:function(){var a=
Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-40;this.stage.css({height:this.height+"px",top:b+"px"});this.searchSwiper.css("height",this.height-88+"px");this.elements.refresh()}}).extend(PcSearchFrame);var phoneGotoPage=Class({create:function(a){this.mainColor=Color(bookConfig.toolbarColor);this.iconColor=Color(bookConfig.iconColor);this.menu=$("<div id='menu' style='position:absolute;width:100%;height:90px;z-index:98;bottom:-100px;overflow:hidden;'></div>");this.background=$("<div id='background' style='position:absolute;width:100%;height:90px;'></div>");this.contentBox=$("<div id='contentBox' class='phoneGotoPageContent' style='position:absolute;width:100%;height:90px;'></div>");this.direction=
...
try{if((isPhone()||isPad())&&window.htmlConfig&&window.htmlConfig.phoneTemplate){var $jscomp$optchain$tmpm1961943135$0,phoneTemplateName=null==($jscomp$optchain$tmpm1961943135$0=window.htmlConfig.phoneTemplate)?void 0:$jscomp$optchain$tmpm1961943135$0.name,$jscomp$optchain$tmpm1961943135$1,phoneTemplatePath=null==($jscomp$optchain$tmpm1961943135$1=window.htmlConfig.phoneTemplate)?void 0:$jscomp$optchain$tmpm1961943135$1.path;if(phoneTemplateName&&phoneTemplatePath&&["neat","classical"].includes(phoneTemplateName.toLowerCase())){var toolbarUrl=
...
function(){console.log("editItNowButton")})}});var ThumbnailCell=Class({create:function(a,b){this.parent=a;this.margin=12;this.height=135;this.index=b;this.item=$("<div aria-label='"+getLanguage("ariaPage","page")+" "+this.index+"' tabindex='-1' class='item button'></div>");this.initHtml();this.initEvent();this.onResize()},onResize:function(){this.imageHeight=105;this.length=this.imageWidth=parseInt(bookConfig.largePageWidth*this.imageHeight/bookConfig.largePageHeight);this.image.css({width:this.imageWidth+"px",height:this.imageHeight+"px"});
this.noThumbBg.css({width:this.imageWidth+"px",height:this.imageHeight+"px"})},initHtml:function(){this.initStructure();this.item.append(this.noThumbBg).append(this.image);this.item.append(this.title);this.parent.append(this.item)},loading:function(){this.image.css({"background-color":"#ffffff","background-image":"url("+bookConfig.pageLoadingUrl+")","background-repeat":"no-repeat","background-position":"center"})},unLoading:function(){this.image.removeAttr("style")},initStructure:function(){this.image=
$("<img/>");this.noThumbBg=$("<div class='noThumbBg' style='display:none;margin: 0 auto;background:"+bookConfig.pageBackgroundColor+";height:100%;'></div>");this.title=$("<p class='title'>"+getShownPageNumber(this.index)+"</p>");this.loading()},setStyle:function(a){this.item.css(a)},addClass:function(a){this.item.addClass(a)},removeClass:function(a){this.item.removeClass(a)},initEvent:function(){this.item.onTap(function(){gotoPageFun(this.index,!1,"thumbnail")}.bind(this))},fillContent:function(a){a=
...
this.item.addClass("focus")},merge:function(){this.title.hide();this.item.removeClass("focus")},setHighLight:function(a){this.index==a&&this.item.addClass("highlight")},clearHighLight:function(){this.item.removeClass("highlight")}});var ThumbnailItem=Class({create:function(a,b){this.parent=a;this.margin=12;this.height=135;this.pages=b;this.cells=[];this.initHtml();this.onResize()},onResize:function(){this.length=2*this.cells[0].length;this.item.css({width:this.length+"px"})},initHtml:function(){this.item=$("<div class='item_focus'></div>");this.initStructure();this.addItem();this.item.append(this.title);this.parent.append(this.item)},initStructure:function(){this.initCells();for(var a=getShownPageNumber(this.cells[0].index),
b=1;b<this.cells.length;b++)a=a+"-"+getShownPageNumber(this.cells[b].index);1==this.cells.length?BookInfo.isLeftPage(this.cells[0].index,!0)?(this.title=$("<p class='last_title'>"+a+"</p>"),this.item.addClass("last_item")):(this.title=$("<p class='first_title'>"+a+"</p>"),this.item.addClass("first_item")):this.title=$("<p class='title'>"+a+"</p>")},addItem:function(){for(var a=this.cells.length,b=0;b<a;b++)this.item.append(this.cells[b].getDom())},fillContent:function(){for(var a=this.cells.length,
b=0;b<a;b++)this.cells[b].fillContent(0)},initCells:function(){for(var a=0;a<this.pages.length;a++){var b=new ThumbnailCell(this.item,this.pages[a]);this.cells.push(b)}},setPosition:function(a,b){this.item.css(b,a+"px")},fission:function(){this.item.removeClass("focus");1==this.cells.length?(BookInfo.isLeftPage(this.cells[0].index,!0)?this.cells[0].setStyle({left:"0",right:"auto"}):this.cells[0].setStyle({right:"-6px",left:"auto"}),this.cells[0].fission()):(this.cells[0].fission(),this.cells[1].fission(),
this.cells[0].setStyle({left:"0",right:"auto"}),this.cells[1].setStyle({right:"-6px",left:"auto"}),this.cells[0].removeClass("left"),this.cells[1].removeClass("right"))},merge:function(){this.item.addClass("focus");1==this.cells.length?(BookInfo.isLeftPage(this.cells[0].index,!0)?this.cells[0].setStyle({left:"0",right:"auto"}):this.cells[0].setStyle({right:"0",left:"auto"}),this.cells[0].merge()):(this.cells[0].merge(),this.cells[1].merge(),this.cells[0].setStyle({left:"0",right:"auto"}),this.cells[1].setStyle({right:"0",
left:"auto"}),this.cells[0].addClass("left"),this.cells[1].addClass("right"))},setHighLight:function(a){for(var b=0;b<this.cells.length;b++)this.cells[b].setHighLight(a);this.item.addClass("highlight")},clearHighLight:function(){this.item.removeClass("highlight");for(var a=0;a<this.cells.length;a++)this.cells[a].clearHighLight()}});var ThumbnailFrame=Class({create:function(a){this._super(a);this.direction=Direction.top;this.horizontalDirection=rightToLeft?Direction.right:Direction.left;this.leftButtonUrl=uiBaseURL+"left.png";this.rightButtonUrl=uiBaseURL+"right.png";this.itemArray=[];this.taskList=new TaskList;this.initDefaultDom();this.initHtml();this.initEvent();this.refresh();this.initCss();this.hide()},initHtml:virtual_function,initCss:function(){rightToLeft&&this.stage.addClass("rightToLeft");this.thumbnailSwiperList.css({height:this.topLength+
125+"px"});this.initColorCss()},initColorCss:function(){var a=Color(this.mainColor);this.stage.css({"background-color":a.rgba(.6),color:this.fontColor});this.close.css({"background-color":a.rgba(0)})},initDefaultDom:function(){this.closeUrl=form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.close=$("<img alt='close' width='auto' height='auto' class='close' src='"+this.closeUrl+"' />");this.close.click(this.hide.bind(this));this.close.changeButtonColor(this.fontColor);
...
emailButton:"",
...
magnifier:"",
text:"iVBORw0KGgoAAAANSUhEUgAAABYAAAAWCAYAAADEtGw7AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFVJREFUeNpi/P//PwMtABMDjQALGp9S5zPS3cVYbUfzDSMxvmQi0lAGEhyA02BGSsIWl8GM1Ig4mkbeqMGjBo8aTGbphqvk+k9METBgLmYcdGEMEGAAMacIN+Xk/EcAAAAASUVORK5CYII=",phone:"",
previous_normal:"",
previous_normal_down:"",
next_normal_down:"",
next_normal:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.containerRight=a.containerRight;this.pageContainer=a.pageContainer;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:10,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length;this.buttons.each(function(b){b.freedom();b.$button.css({background:Color(bookConfig.iconColor).rgba()});b.title&&(b.title.direction=TextBubble.VERTICAL,
b.title.arrowWidth=8,b.title.arrowHeight=4)});this.pickButtons()},pickButtons:function(){this.btnFirst=this.buttons.find("first").get(0);this.btnPrevious=this.buttons.find("previous").get(0);this.btnNext=this.buttons.find("next").get(0);this.btnLast=this.buttons.find("last").get(0);this.btnMore=this.buttons.find("more").get(0);this.btnMore.$button.addClass("btnMore");this.buttons.remove(this.btnFirst);this.buttons.remove(this.btnPrevious);this.buttons.remove(this.btnNext);this.buttons.remove(this.btnLast);
this.buttons.remove(this.btnMore);this.pageButtonCount=4;bookConfig.enablePageBack&&(this.btnBackward=this.buttons.find("backward").get(0),this.btnForward=this.buttons.find("forward").get(0),this.buttons.remove(this.btnBackward),this.buttons.remove(this.btnForward),this.pageButtonCount=6);this.buttonCount=this.buttons.length},sort:virtual_function});
Class("PCButtonQueue",{sort:function(){var a=this.buttonWidth+10,b=0;this.mostNum=this.buttons.length;var c=Math.floor((this.container.width-50)/a);this.buttons.length/2-parseInt(this.buttons.length/2)&&(this.mostNum+=1);c>Math.floor(this.mostNum/2)&&(c=Math.floor(this.mostNum/2));var d=c;a=Number.between(c+d,0,this.buttonCount);var e=50;a<this.buttonCount&&a--;for(var f=0;f<this.buttons.length;f++){var g=this.buttons.get(f);f<a?f<c?(g==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&
(VolumeControlBar.config.direction=VolumeControlBar.TOP,g.title=!1),"WeChatShareButton"==g.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.TOP),"TelephoneNumberButton"==g.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.TOP),g.addTo(this.container.body),g.setPosition(e,this.buttonTop),e+=this.buttonWidth+10):(g==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.TOP,g.title=!1),"WeChatShareButton"==
g.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.TOP),"TelephoneNumberButton"==g.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.TOP),g.addTo(this.containerRight.body),b=50*parseInt(2*d-f),g.$button.css({right:b+"px",top:this.buttonTop+"px",left:"auto"})):(g==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,g.title=!1),"WeChatShareButton"==g.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT),
"TelephoneNumberButton"==g.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),g.addTo(this.extended),g.$button.css({background:"transparent"}),g.title&&(g.title.direction=TextBubble.LEFT,g.title.arrowWidth=4,g.title.arrowHeight=8))}c=windowWidth-210;a<this.buttonCount&&(b=50>=b-50?45>this.containerRight.width?10:50:b-50,this.btnMore.$button.css({top:this.buttonTop+"px",right:b+"px"}),this.btnMore.title&&(this.btnMore.title.direction=TextBubble.RIGHT,this.btnMore.title.arrowWidth=
4,this.btnMore.title.arrowHeight=8),334>=c&&this.btnMore.$button.css({top:this.buttonTop+"px",right:(c-80)/2+"px"}),this.btnMore.addTo(this.containerRight.body));530<=c&&(bookConfig.enablePageBack&&(this.btnBackward.$button.css({display:"block"}),this.btnForward.$button.css({display:"block"})),this.btnFirst.$button.css({display:"block"}),this.btnLast.$button.css({display:"block"}),this.btnPrevious.$button.css({display:"block"}),this.btnNext.$button.css({display:"block"}));530>c&&430<c&&(bookConfig.enablePageBack&&
(this.btnBackward.$button.css({display:"none"}),this.btnForward.$button.css({display:"none"})),this.btnFirst.$button.css({display:"block"}),this.btnLast.$button.css({display:"block"}),this.btnPrevious.$button.css({display:"block"}),this.btnNext.$button.css({display:"block"}));430>=c&&334<c&&(this.btnFirst.$button.css({display:"none"}),this.btnLast.$button.css({display:"none"}),this.btnBackward&&this.btnBackward.$button.css({display:"none"}),this.btnForward&&this.btnForward.$button.css({display:"none"}),
this.btnPrevious.$button.css({display:"block"}),this.btnNext.$button.css({display:"block"}));334>=c&&(this.btnFirst.$button.css({display:"none"}),this.btnLast.$button.css({display:"none"}),this.btnBackward&&this.btnBackward.$button.css({display:"none"}),this.btnForward&&this.btnForward.$button.css({display:"none"}),this.btnPrevious.$button.css({display:"none"}),this.btnNext.$button.css({display:"none"}));this.addPageButtons()},addPageButtons:function(){function a(k){k.addTo(e);k.setPosition(f,h);
f+=g+10}function b(){edtPageNumberLeft=(d-m)/2;l.css({left:edtPageNumberLeft+"px",top:"-40px",width:m+"px",display:"block"});l.find("input").css({width:m+"px"})}var c=4;bookConfig.enablePageBack&&(c+=2);var d=this.pageContainer.width,e=this.pageContainer.body,f=Math.floor((d-(2*this.edtNumber.space+c*(this.buttonWidth+10)-10))/2)+4,g=this.buttonWidth,h=this.edtNumber.top-15,l=this.edtNumber.body,m=this.edtNumber.width;rightToLeft?(bookConfig.enablePageBack&&a(this.btnForward),a(this.btnLast),a(this.btnNext),
b(),a(this.btnPrevious),a(this.btnFirst),bookConfig.enablePageBack&&a(this.btnBackward)):(bookConfig.enablePageBack&&a(this.btnBackward),a(this.btnFirst),a(this.btnPrevious),b(),a(this.btnNext),a(this.btnLast),bookConfig.enablePageBack&&a(this.btnForward))}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){VolumeControlBar.config={color:this.color.rgba(.7),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.TOP,deviation:-2};this.topBar=$('<div class="fbTopBar" style=\'height:42px;\' id = "fbTopBar"></div>');this.logoBar=$("<div id='logoBar' class='bottom left logoBar'></div>");this.bottomBar=$("<div class='fbToolBar' id='fbToolBar'></div>");this.buttonBar=$("<div class='buttonBar'></div>");this.buttonBarRight=$("<div class='buttonBarRight'></div>");
this.pageBar=$("<div class='pageBar' ></div>");this.boardBar=$("<div class='fbBoardBar' id='fbBoardBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'>\n\t\t\t<label><input aria-label='"+getLanguage("ariaPageNumber","page number")+"' aria-labelledby='currentPageIndex' autocomplete='off' type='text' class='inputInnerShadow' id='currentPageIndexTextField' /></label>\n\t\t\t<span class=\"editNumBevel\"></span></div>");this.parent.append(this.topBar);this.parent.append(this.boardBar);
this.parent.append(this.bottomBar);this.topBar.append(this.logoBar);this.bottomBar.append(this.pageBar);this.bottomBar.append(this.buttonBar);this.bottomBar.append(this.buttonBarRight);this.pageBar.append(this.edtPageNumber);this.initPageNumber();this.initBoard()},initBoard:function(){this.bottomBar.css({"border-bottom":"5px solid "+this.color.rgba(this.topBarAlpha)});this.boardBar.css({"border-bottom":"35px solid "+Color(this.color).rgba(.7*this.topBarAlpha)})},initPageNumber:function(){this.edtPageNumber.css({background:this.color.rgba(.7)});
var a=this.edtPageNumber.find("input"),b=this.edtPageNumber.find("span"),c=Color(bookConfig.pageNumColor);a.css({background:"rgba(255,255,255,0.1)",color:c.toString()});var d=parseInt(bookConfig.totalPageCount),e=16;""==bookConfig.pageNumberCaption&&(1E4<=d&&(e=21),1E4>d&&(e=15),1E3>d&&(e=10),100>d&&(e=6),10>d&&(e=4));a.attr("size",e);this.edtPageWidth=this.edtPageNumber.width();a=.7*a.width();b.css({width:a+"px",left:(this.edtPageWidth-a)/2+"px","border-bottom":"1px dotted "+c.toString()})},setButtonTitle:function(a){if("WeChatShareButton"==
a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:7});
a.setTitle(b)}},initButtons:function(){this._super();this.buttons.each(function(a){a.color=this.color})},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,
b){if(bookConfig.ToolBarVisible){void 0==a&&(a=this.parent.width());void 0==b&&this.parent.height();b=parseInt(a)/3;this.topBar.css({width:b+"px"});b=parseInt(a)-210;this.pageCount=bookConfig.enablePageBack?6:4;430<b&&530>b&&(this.pageCount=4);430>b&&(this.pageCount=2);a=(parseInt(a)-b)/2;this.bottomBar.css({width:b+"px",left:a+"px"});this.boardBar.css({width:b-60+"px",left:a+"px"});a=10+50*this.pageCount-10;b=(b-a)/2;var c=b-20;this.pageBar.css({left:b+"px",width:a+"px"});this.buttonBar.css({width:c+
"px"});this.buttonBarRight.css({width:c+"px"});this.pageBarWidth=a;this.buttonBarWidth=c;this.resetButtonPosition()}},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:40,buttonTop:-5,container:{body:this.buttonBar,width:this.buttonBarWidth},containerRight:{body:this.buttonBarRight,width:this.buttonBarWidth},pageContainer:{body:this.pageBar,width:this.pageBarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,width:this.edtPageWidth,top:10,space:5}})).sort();
this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.setCallback(this.afterButtonClick.bind(this));a.changeColor(Color(this.color).toString());this.drawReflect(a);a.$button.bind("mouseenter",function(){a.$button.addClass("focus")});a.$button.bind("mouseleave",function(){a.$button.removeClass("focus")})}.bind(this))},drawReflect:function(a){var b=null;a.$button.find("canvas")&&(b=a.$button.find("canvas"));var c=document.createElement("canvas"),
d=c.getContext("2d",{willReadFrequently:!0});c.width="40";c.height="16";c.className="divReflect";d.beginPath();var e=d.createLinearGradient(0,0,0,12);e.addColorStop(0,Color(bookConfig.iconColor).rgba(.3));e.addColorStop(1,Color(bookConfig.iconColor).rgba(0));d.arc(20,22,20,0,360,!1);d.fillStyle=e;d.fill();d.closePath();a.$button.append(c);b&&b.remove()},resetButtonColor:function(){for(var a=0;a<this.buttons.objects.length;a++){var b=this.buttons.objects[a];b.resetImg();b.color=Color(bookConfig.iconColor);
b.fontColor=Color(bookConfig.iconFontColor);b.changeIconColor(bookConfig.iconColor);b.changeCaptionColor(bookConfig.iconFontColor);this.drawReflect(b);b.title&&b.title.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})}bookConfig.QRCode&&global.qrButton&&global.qrButton.visible&&global.qrButton.resetIconColor()},getBottomHeight:function(){var a=this.visible?this.bottomBar?this.bottomBar.height()+this.bottomBar.bottom()+45:0:0;NeatStyle.isNeat()&&(iHeight=40);thumbnail&&(a+=
thumbnail.getBottomHeight());return a},show:function(){if(bookConfig.ToolBarVisible&&!this.isMoving&&!this.visible){this._super();var a=transformCSS({tran:{x:0,y:0}});animateOnce(this.boardBar,a,500);this.topBar.show()}},hide:function(){if(bookConfig.ToolBarVisible&&!this.isMoving&&this.visible){var a=this.getBottomHeight()+5;a=transformCSS({tran:{x:0,y:a}});animateOnce(this.boardBar,a,500);this.topBar.hide();this._super()}},afterButtonClick:function(a){this._super(a);this.drawReflect(a);a.getStatus&&
a.changeColor(this.color)},getTopHeight:function(){return thumbnail?thumbnail.getHeight():0}}).extend("Toolbar");
Class("PCExtendedBar",{show:function(a){if(1!=this.isMoving&&1!=this.visible){this.visible=this.isMoving=!0;this.$bar.css({left:a.left+a.width-this.width-2+"px",bottom:"45px"});var b=0;this.$bar.css({display:"block",opacity:0,background:Color(bookConfig.iconColor).rgba(.5)});var c=function(){b+=.1;this.$bar.css({opacity:b});equals(b,1)&&(c.stop(),this.isMoving=!1)}.interval(this,40)}},resize:function(a){for(var b=0;b<a.length;b++)a.get(b).setPosition(8,10+29*b);this.width=40;this.height=29*a.length+
30;this.$bar.css({width:this.width+"px",height:this.height+"px"})}}).extend("ExtendedBar");var hexcase=0,b64pad="",chrsz=8;function compareov(){var a=Date.parse(new Date);return orgt(a)===vldt(a)}function orgt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}function vldt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}
