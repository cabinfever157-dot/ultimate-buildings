...
export default function PrefabConstructionPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <iframe ref={iframeRef} className="w-full border-none" style={{ height: "calc(100vh - 100px)", marginTop: "100px", display: mounted ? "block" : "none" }} title="Prefab Construction" allow="fullscreen" />
    </div>
  );
}
